...
class AdminTechnician extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void updateTechnicianStatus(Map<String, String> updatedData) async {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () {
                          updateTechnicianStatus({"status": "suspended"});
                        },
                        style: ButtonStyle(
                      ...
                      ElevatedButton(
                        onPressed: () {
                          updateTechnicianStatus({"status": "accepted"});
                        },
                        style: ButtonStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          updateTechnicianStatus({"status": "declined"});
                        },
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all<Color>(Colors.red),
                        ),
